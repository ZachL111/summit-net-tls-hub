"""Regression checks for the summit-net-tls-hub casebook."""
...
from casebook.harness import assert_expected, summit_net_tls_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_net_tls_hub_summary(), assert_expected())
